...
# ============================================================
# ACCESSAI NEXUS
# Personalized Hands-Free Computer Accessibility
#
# FACE:
#   Head movement -> Cursor
#   Blink         -> Click
#   Head tilt     -> Adaptive continuous scroll
#
# VOICE:
#   Backup computer commands
#
# CALIBRATION:
#   Automatically loads calibration_profile.json
# ============================================================
...
def load_calibration():
    ...
    global CONTROL_LEFT
    global CONTROL_RIGHT
    global CONTROL_TOP
    global CONTROL_BOTTOM

    print()
    print("=" * 60)
    print("ACCESSAI PERSONALIZATION")
    print("=" * 60)
    ...
    try:
        ...
        if not (
            ...
            raise ValueError(
                "Invalid horizontal calibration."
            )
        ...
        if not (
            ...
            raise ValueError(
                "Invalid vertical calibration."
            )

        CONTROL_LEFT = new_left
        CONTROL_RIGHT = new_right

        CONTROL_TOP = new_top
        CONTROL_BOTTOM = new_bottom

        print(
            "✓ Personalized calibration loaded."
        )
...
# Existing smooth settings preserved.
...
# Existing working blink settings preserved.
...
# Existing fast adaptive scrolling preserved.
...
def voice_worker():
    ...
    while voice_running:
        ...
        try:
            ...
            # =================================================
            # IMPORTANT:
            # Use the same simple WAV recognition method
            # that successfully recognized "select" in
            # test_raw.py.
            # =================================================
...
def main():
    ...
    print(
        "  Head tilt      -> Adaptive Scroll"
    )

    print()
    print("PERSONALIZATION")
    print(
        "  Calibration profile loaded automatically"
    )
