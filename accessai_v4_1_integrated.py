...
def _handle_text_input(text):
    ...
    exit_typing_phrases = {
        "exit typing", "exit typing mode", "exit typing mood",
        "stop typing", "stop typing mode", "stop typing mood",
        "disable typing", "disable typing mode",
        "end typing", "end typing mode", "leave typing",
        "leave typing mode", "quit typing", "quit typing mode",
        "turn off typing", "turn off typing mode",
        "close typing mode"
    }
    ...
    if typing_mode and _close_match(command, exit_typing_phrases, 0.82):
        typing_mode = False
        set_status("COMMAND MODE", 2)
        print("⌨ COMMAND MODE — speak commands normally")
        return True

    # Safety: while typing mode is active, explicit exit phrases always
    # take priority over treating the words as text.
    if typing_mode and (
        command.startswith("exit typing")
        or command.startswith("stop typing")
        or command.startswith("disable typing")
        or command.startswith("end typing")
        or command.startswith("leave typing")
        or command.startswith("quit typing")
        or command.startswith("turn off typing")
    ):
        typing_mode = False
        set_status("COMMAND MODE", 2)
